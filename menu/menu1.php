            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-md-6 mx-auto">
                        <a href="../resultados/verEncuesta1.php" class="btn btn-outline-primary btn-lg btn-block">
                            Resultados de Encuestas
                        </a>
                    </div>
                    <div class="col-md-6 mx-auto">
                        <a href="../graficas/grafica1.php"
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6 mx-auto">
                            <a href="../encuestas/encuesta1.php" class="btn btn-outline-primary btn-lg btn-block">
                                Encuesta
                            </a>
                        </div>
                    </div>
