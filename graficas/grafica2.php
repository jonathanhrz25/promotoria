...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
            <a class="navbar-brand" href="../menu/menu2.php">
    ...
    <body style="padding-top: 40px;">
        ...
        $sql = "SELECT * FROM alternadores_formulario";
        $stmt = $conn->query($sql);
            ...
            function drawChartPregunta1() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($valores as $valor) {
                        $sql = "SELECT COUNT(*) as total FROM alternadores_formulario WHERE cliente = '$valor'";
        ...
        <script>
            ...
            function drawChartPregunta2() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($valores as $valor) {
                        $sql = "SELECT COUNT(*) as total FROM alternadores_formulario WHERE piezas = '$valor'";
                        $resultado = $conn->query($sql);
                        $fila = $resultado->fetch_assoc();
                        echo "['$valor', " . $fila['total'] . "],";
                    }
                ...
                var options = {
                    title: '2. ¿Comercializa unidades completas de alternadores, arranques?',
                    is3D: true,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
                };
            ...
            function drawChartPregunta5() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($marcas as $marca) {
                        $sql = "SELECT COUNT(*) as total FROM alternadores_formulario WHERE marca LIKE '%$marca%'";
                        $resultado = $conn->query($sql);
                        $fila = $resultado->fetch_assoc();
                ...
                var options = {
                    title: '5. ¿Qué marcas de unidades completas en alternadores o arranques comercializa?',
                    is3D: true,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
                };
            ...
            function drawChartPregunta6() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($opciones as $opcion) {
                        $sql = "SELECT COUNT(*) as total FROM alternadores_formulario WHERE razon_aser LIKE '%$opcion%'";
                        $resultado = $conn->query($sql);
                        $fila = $resultado->fetch_assoc();
                ...
                var options = {
                    title: '6. ¿Cuál es la razón por la cual no adquiere unidades completadas de ASER, ASER PREMIUM?',
                    is3D: true,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
                };
        ...
        <script>
            ...
            function drawChartPregunta6() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($opciones as $opcion) {
                        $sql = "SELECT COUNT(*) as total FROM alternadores_formulario WHERE razon_wai LIKE '%$opcion%'";
                        $resultado = $conn->query($sql);
                        $fila = $resultado->fetch_assoc();
                        echo "['$opcion', " . $fila['total'] . "],";
                    }
                ...
                var options = {
                    title: '7. ¿Cuál es la razón por la cual no adquiere unidades completadas de WAI?',
                    is3D: true,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
                };
        ...
        <script>
            ...
            function drawChartPregunta6() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($opciones as $opcion) {
                        $sql = "SELECT COUNT(*) as total FROM alternadores_formulario WHERE razon_seg LIKE '%$opcion%'";
                        $resultado = $conn->query($sql);
                        $fila = $resultado->fetch_assoc();
                        echo "['$opcion', " . $fila['total'] . "],";
                    }
                ...
                var options = {
                    title: '8. ¿Cuál es la razón por la cual no adquiere unidades completadas de SEG?',
                    is3D: true,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
                };
            ...
            function drawChartPregunta7() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    foreach ($respuestas as $respuesta) {
                        $sql = "SELECT COUNT(*) as total FROM alternadores_formulario WHERE despiece = '$respuesta'";
                        $resultado = $conn->query($sql);
                        $fila = $resultado->fetch_assoc();
                ...
                var options = {
                    title: '9. ¿Comercializa despiece de arranques, alternador?',
                    is3D: true,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
                };
        ...
        <script>
            ...
            function drawChartPregunta13() {
                ...
                $valores = [];
                foreach ($opciones as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE proveedor_opcion = ?");
                ...
                var options = {
                    title: '12. ¿En qué lugar nos considera como proveedor?',
                    is3D: true,
                    pieHole: 0.4,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
        ...
        <script>
            ...
            function drawChartPregunta14() {
                ...
                foreach ($opciones as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE mejoras LIKE ?");
                    $like = '%' . $opcion . '%';
                ...
                var options = {
                    title: '13. Características de la página que recomienda mejorar',
                    is3D: true,
                    pieHole: 0.4,
                    pieSliceText: 'value-and-percentage',
                    legend: { position: 'right' }
                ...
                var chart = new google.visualization.PieChart(document.getElementById('piechart_3d_11'));
                chart.draw(data, options);
            }
        </script>
        ...
        <script>
            ...
            function drawChartPregunta15() {
                <?php
                $opciones_p15 = ['Si, ya sabia', 'No, me estoy enterando'];
                $valores_p15 = [];

                foreach ($opciones_p15 as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE promotoria = ?");
                    $stmt->bind_param("s", $opcion);
                    $stmt->execute();
                    $result = $stmt->get_result()->fetch_assoc();
                ...
                var options = {
                    title: '14. ¿Conoce el departamento de promotoria (soporte tecnico) que automotriz serva cuenta para brindarte una atención personalizada?',
                    is3D: true,
                    pieHole: 0.4,
                    legend: { position: 'bottom' }
                };

                var chart = new google.visualization.PieChart(document.getElementById('piechart_3d_12'));
                chart.draw(data, options);
            }
        </script>
        ...
        <script>
            ...
            function drawChartPregunta16() {
                ...
                foreach ($opciones_p16 as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE fuente_consulta = ?");
                    $stmt->bind_param("s", $opcion);
                    $stmt->execute();
                    $result = $stmt->get_result()->fetch_assoc();
                ...
                var options = {
                    title: '15. ¿Cual es su fuente de consulta para realizar busqueda de piezas en alternadores y arranques?',
                    is3D: true,
                    pieHole: 0.4,
                    legend: { position: 'bottom' }
                };
        ...
        <script>
            ...
            function drawChartPregunta17() {
                ...
                foreach ($opciones_p17 as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE FIND_IN_SET(?, promocionales) > 0");
                    $stmt->bind_param("s", $opcion);
                    $stmt->execute();
                    $result = $stmt->get_result()->fetch_assoc();
                ...
                var options = {
                    title: '16. ¿Qué artículos promocionales le gustaría que lanzara Automotriz SERVA?',
                    is3D: true,
                    pieHole: 0.4,
                    legend: { position: 'right' },
                };
        ...
        <script>
            ...
            function drawChartPregunta18() {
                ...
                foreach ($opciones_p18 as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE FIND_IN_SET(?, articulos) > 0");
                    $stmt->bind_param("s", $opcion);
                    $stmt->execute();
                    $result = $stmt->get_result()->fetch_assoc();
                ...
                var options = {
                    title: '17. ¿Que grupo de articulos comercializa?',
                    is3D: true,
                    pieHole: 0.4,
                    legend: { position: 'right' },
                };
        ...
        <script>
            ...
            function drawChartPregunta19() {
                ...
                foreach ($opciones_p19 as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE sector = ?");
                    $stmt->bind_param("s", $opcion);
                    $stmt->execute();
                    $result = $stmt->get_result()->fetch_assoc();
                ...
                var options = {
                    title: '18. Sector automotriz atendido',
                    is3D: true,
                    pieHole: 0.4,
                    legend: { position: 'right' },
                };
        ...
        <script>
            ...
            function drawChartPregunta20() {
                ...
                foreach ($opciones_p20 as $opcion) {
                    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM alternadores_formulario WHERE FIND_IN_SET(?, armadoras) > 0");
                    $stmt->bind_param("s", $opcion);
                    $stmt->execute();
                    $result = $stmt->get_result()->fetch_assoc();
                ...
                var options = {
                    title: '19. Del sector automotor que atiende, ¿En qué armaduras se especializa tu negocio?',
                    is3D: true,
                    legend: { position: 'right' },
                };
